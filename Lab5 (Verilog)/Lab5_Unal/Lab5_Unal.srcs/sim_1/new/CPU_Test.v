...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    //ID STAGE
    ControlUnit CU(op,func,aluc,wreg,m2reg,wmem,aluimm,regrt); //ControlUnit: inputs op,func fields, outputs aluc,wreg,m2reg,wmem,aluimm into IDEXEReg and regrt into RegisterMux
