...
HD_PWD='C:/Users/Taylan Unal/Desktop/Lab5HonorsOption/Lab5HonorsOption.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PC.tcl -notrace
