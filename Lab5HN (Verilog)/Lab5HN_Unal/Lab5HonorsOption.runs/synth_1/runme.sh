...
HD_PWD='C:/Users/Taylan Unal/Desktop/Lab5HonorsOption/Lab5HonorsOption.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PC.tcl
